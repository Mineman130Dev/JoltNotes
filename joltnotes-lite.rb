cask "joltnotes-lite" do
    ...
    name "JoltNotes Lite" 
    desc "A simple and lightweight note-taking application for Intel Macs running macOS" 
    ...
    zap trash: [
      ...
      "~/Library/Preferences/com.mineman130.joltnoteslite.plist", # Adjust your app's plist identifier
    ]
  end